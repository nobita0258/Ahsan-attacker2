    ...
    async with aiohttp.ClientSession() as session:
        try:
            while True:
                if mode == "multi":
                    tasks = [
                        call_api(session, "sms", target),
                        call_api(session, "wp", target)
                    ]
            ...
            print(f"\n\n\033[1;92m Blast Stopped! Total Hits Sent: {success}\033[0m")
...
async def main():
    while True:
        ...
        print("\033[1;32m" + "━"*45)
        print("\033[1;37m        🚀  \033[1;31mAHSAN ATTACKER TOOL\033[1;37m  🚀")
        print("\033[1;32m" + "━"*45)
        print("\033[1;37m  DEVELOPER : \033[1;33mAHSAN | HACKER")
        ...
        if choice in ["1", "01"]:
            await run_bomber("sms")

        elif choice in ["2", "02"]:
            await run_bomber("wp")

        elif choice in ["3", "03"]:
            await run_bomber("multi")
